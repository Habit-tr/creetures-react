        ...
        <Flex
          ...
          <Stack
            ...
            minW={0}>
              <Avatar
                  size={'lg'}
                  src={'https://gravatar.com/avatar/f5fafa6c888f5875a5fc75609d69b6ef?s=400&d=robohash&r=x'}/>
            </Button>
            ...
            <Popover trigger={'hover'} placement={'bottom-start'}>
              <PopoverTrigger>
                <Link
                  ...
                  fontSize: "1.5em", transition:' .8s ease-in-out' }}>
                  {navItem.label}
                </Link>
              </PopoverTrigger>
  ...
  const DesktopSubNav = ({ label, href, subLabel }: NavItem) => {
    return (
      <Link
        ...
        p={2}
        rounded={'md'}
        _hover={{ bg: useColorModeValue('green.200', 'gray.900'), cursor: "pointer",
        fontSize: "1.2em", }}>
